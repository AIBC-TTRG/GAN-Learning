...
class CustomPoseGenerator(nn.Module):
    # pose_feature_nc  128 reid_feature_nc  2048   noise_nc 256 
    def __init__(self, pose_feature_nc, reid_feature_nc, noise_nc, pose_nc=18, output_nc=3, 
        ...
        print('CustomPoseGenerator__init__')
        # print('pose_feature_nc')
        # print(pose_feature_nc)
        # print('reid_feature_nc')
        # print(reid_feature_nc)
        # print('noise_nc')
        # print(noise_nc)
    ...
    def _make_layer_encode(self, in_nc, out_nc):
        print('CustomPoseGenerator___make_layer_encode1111111111__')
    ...
    def _make_layer_decode(self, in_nc, out_nc):
        print('CustomPoseGenerator___make_layer_decode11111__')
        block = [nn.ReLU(True),
    ...
    def decode(self, model, fake_feature, pose_feature, cnlayers):
        print('CustomPoseGenerator__decode__')
        if cnlayers>0:
    ...
    def forward(self, posemap, reid_feature, noise):
        print('CustomPoseGenerator__forward__')
...
class NLayerDiscriminator(nn.Module):
    def __init__(self, input_nc, norm_layer=nn.BatchNorm2d):
        print('NLayerDiscriminator__init__')
    ...
    def forward(self, input):
        print('NLayerDiscriminator__forward__')
