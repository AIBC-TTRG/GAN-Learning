...
class Preprocessor(object):
    ...
    def __len__(self):
        # print('Preprocessor____len____')
        return len(self.dataset)

    def __getitem__(self, indices):
        # print('Preprocessor____getitem____')
    ...
    def _get_single_item(self, index):
        ...
        # print('Preprocessor___get_single_item__')
    ...
    def _get_single_item_with_pose(self, index):
        # print('Preprocessor___get_single_item_with_pose__')
        fname, pid, camid = self.dataset[index]
        fpath = fname
        if self.root is not None:
            fpath = osp.join(self.root, fname)
    ...
    def _load_landmark(self, path, scale_h, scale_w):
        # print('Preprocessor___load_landmark__')
        landmark = []
    ...
    def _generate_pose_map(self, landmark, gauss_sigma=5):
        # print('Preprocessor___generate_pose_map__')
        maps = []
